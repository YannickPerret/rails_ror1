...
class ClassStudentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create class_student" do
    assert_difference("ClassStudent.count") do
      post class_students_url, params: { class_student: { school_class_id: @class_student.school_class_id, student_id: @class_student.student_id } }
    end
  ...
  test "should update class_student" do
    patch class_student_url(@class_student), params: { class_student: { school_class_id: @class_student.school_class_id, student_id: @class_student.student_id } }
